...
id, invalid = first_invalid_number_xmas(data, 25)
print(f'Parto one: {invalid}')

def encryption_weakness(cipher, invalid, id):
	cipher = cipher[:invalid]
...
print(f'Part two: {encryption_weakness(data, invalid, id)}')